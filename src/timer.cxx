...
namespace profiling
{
	...
	namespace timers
	{
		...
		{
#ifdef NO_TIMER
			profiling::output::printMessage(" No timers initialization - timers are disabled by the ROCKABLE_USE_NO_TIMER option");
			return; // end here
#endif
			profiling::output::printMessage(" Timers initialization ");
		...
		{
#ifdef NO_TIMER
			profiling::output::printMessage(" No timetable - timers are disabled by the ROCKABLE_USE_NO_TIMER option");
			return; // end here
#endif
